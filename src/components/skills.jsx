...
import { Waypoint } from 'react-waypoint'; // Import Waypoint
...
const Skills = () => {
  ...
  const handleWaypointEnter = () => {
    // Trigger the animation only once when the component enters the viewport
  ...
  return (
    <section id="skills" className="skills section">
      ...
      <div className="container" data-aos="fade-up" data-aos-delay="100">
        {/* Waypoint component to detect when the skills section is visible */}
            ...
            <div className="progress">
              ...
              <div className="progress-bar-wrap">
                <div
                  ...
                  aria-valuemin="0"
                  aria-valuemax="100"
                  style={{ width: animationTriggered ? '100%' : '0%' }} // Animate width based on state
                ></div>
              </div>
            </div>
            ...
            <div className="progress">
              ...
              <div className="progress-bar-wrap">
                <div
                  ...
                  aria-valuemin="0"
                  aria-valuemax="100"
                  style={{ width: animationTriggered ? '90%' : '0%' }}
                ></div>
              </div>
            </div>
            ...
            <div className="progress">
              ...
              <div className="progress-bar-wrap">
                <div
                  ...
                  aria-valuemin="0"
                  aria-valuemax="100"
                  style={{ width: animationTriggered ? '75%' : '0%' }}
                ></div>
              </div>
            </div>
            ...
            <div className="progress">
              ...
              <div className="progress-bar-wrap">
                <div
                  ...
                  aria-valuemin="0"
                  aria-valuemax="100"
                  style={{ width: animationTriggered ? '80%' : '0%' }}
                ></div>
              </div>
            </div>
            ...
            <div className="progress">
              ...
              <div className="progress-bar-wrap">
                <div
                  ...
                  aria-valuemin="0"
                  aria-valuemax="100"
                  style={{ width: animationTriggered ? '55%' : '0%' }}
                ></div>
              </div>
            </div>
