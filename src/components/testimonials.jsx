...
const Testimonials = () => {
  const swiperRef = useRef(null); // Ref to hold the Swiper instance

  useEffect(() => {
    // Swiper initialization is now handled by the Swiper React component
    // We just need to ensure the modules are used and config is passed.
    // The Swiper component itself will handle creation and destruction.
  }, []);
